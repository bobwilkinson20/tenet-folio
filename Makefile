...
dev-paper: ## Run dev servers with TENET_PROFILE=paper
	TENET_PROFILE=paper $(MAKE) dev

dev-test: ## Run dev servers with TENET_PROFILE=test
	TENET_PROFILE=test $(MAKE) dev
